...
import {
  ...
  SheetHeader,
  SheetTitle,
} from '@tesser-streams/ui/components/sheet';
import { Skeleton } from '@tesser-streams/ui/components/skeleton';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
    ...
    >
      ...
      >
        <div
          ...
          className='card-gradient flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-[1rem] group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm'
        >
          {children}
        </div>
      </div>
