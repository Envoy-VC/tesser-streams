...
library TesserProxyLib {
    ...
    function removeFunction(
        ...
        require(
            ...
            "TesserProxyLib: Can't remove function that doesn't exist"
        );
        // an immutable function is a function defined directly in a diamond
        require(
            _facetAddress != address(this),
            "TesserProxyLib: Can't remove immutable function"
        );
    ...
    function removeFunctions(
        ...
        require(
            ...
            "TesserProxyLib: No selectors in facet to cut"
        );
        DiamondStorage storage ds = diamondStorage();
        // if function does not exist then do nothing and return
        require(
            _facetAddress == address(0),
            "TesserProxyLib: Remove facet address must be address(0)"
        );
        for (
    ...
    function replaceFunctions(
        ...
        require(
            _facetAddress != address(0),
            "TesserProxyLib: Add facet can't be address(0)"
        );
        ...
        for (
            ...
            require(
                ...
                "TesserProxyLib: Can't replace function with same function"
            );
            removeFunction(ds, oldFacetAddress, selector);
    ...
    function addFunctions(
        ...
        for (
            ...
            require(
                ...
                "TesserProxyLib: Can't add function that already exists"
            );
            addFunction(ds, selector, selectorPosition, _facetAddress);
            selectorPosition++;
        }
